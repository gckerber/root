...
module.exports = async function (context, req) {
  ...
  if (!container || !ALLOWED_CONTAINERS.includes(container)) { context.res = { status: 400, headers: h, body: { message: 'Invalid container' } }; return }
  ...
  try {
    ...
    context.res = { status: 500, headers: h, body: { message: err.message || 'Could not generate upload URL' } }
  }
}
