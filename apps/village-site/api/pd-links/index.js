// apps/village-site/api/pd-links/index.js
// Read-only — Police Dept links & resources
// Partition key: /type  (always 'link')
const { CosmosClient } = require('@azure/cosmos')

let _client = null
function getContainer() {
  if (!_client) _client = new CosmosClient(process.env.COSMOS_CONNECTION_STRING)
  return _client.database('pddb').container('pdLinks')
}
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    context.log.error('PdLinks error:', err.message)
