// apps/village-site/api/village-images/index.js
// Read-only — village site hero carousel images
// Partition key: /type  (always 'image')
const { CosmosClient } = require('@azure/cosmos')

let _client = null
function getContainer() {
  if (!_client) _client = new CosmosClient(process.env.COSMOS_CONNECTION_STRING)
  return _client.database('villagedb').container('villageImages')
}
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    context.log.error('VillageImages error:', err.message)
