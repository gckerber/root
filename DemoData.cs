...
public static class DemoData
{
    ...
    [
        ...
        new() { Id = "7", Name = "George Kerber", Title = "Other", Order = 6,
    ...
    [
        ...
        new() { Id = "b2", Category = "event", Pinned = false,
            ...
            Body = "Join your neighbors for our annual village clean-up! Meet at Village Hall at 9 AM. Gloves and bags provided. Light refreshments served. All ages welcome.",
            Link = "/calendar" },
        new() { Id = "b3", Category = "notice", Pinned = false,
            Date = DateTime.UtcNow.AddDays(-7).ToString("o"),
            Title = "Next Regular Council Meeting",
            Body = "The next regular meeting of the Village Council will be held at Village Hall. All residents are welcome and encouraged to attend." },
    ];
    ...
    [
        new() { Id = "m1", Year = 2025, MeetingDate = new DateTime(2025, 3, 15).ToString("o"),
            ...
            Description = "Discussion of road improvements on Main Street, water system maintenance schedule, and community event planning for summer 2025." },
        new() { Id = "m2", Year = 2025, MeetingDate = new DateTime(2025, 2, 17).ToString("o"),
            ...
            Description = "Budget review for fiscal year 2025, approval of new zoning variance request, and review of village ordinance updates." },
        new() { Id = "m3", Year = 2024, MeetingDate = new DateTime(2024, 12, 16).ToString("o"),
            Title = "December 16, 2024 Council Meeting", Type = "Regular Session", Approved = true,
            Description = "Year-end financial review, approval of 2025 budget, and recognition of retiring council member." },
    ];
    ...
    public static List<Photo> Photos =>
        Enumerable.Range(1, 6).Select(i => new Photo
        {
            Id = $"p{i}",
            Caption = new[] {
            ...
            Year = new[] { 1910, 1925, 1938, 1902, 1955, 1948 }[i - 1],
